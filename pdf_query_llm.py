...
def get_relevant_chunks(corpus_embeddings, query_embedding, chunks, top_k=5, relevance_threshold=0.4):
    """
...
def process_pdf(pdf_path, embedding_model):
    """
    Extract text from a PDF, split it into chunks, and generate embeddings.
    """
...
def main():
    ...
    if os.path.exists(embeddings_file):
        ...
        corpus_embeddings, chunks = process_pdf(pdf_path, embedding_model)
